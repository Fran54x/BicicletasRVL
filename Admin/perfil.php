    ...
    <body>
        ...
        <section class="tarjeta">
            ...
            <form id="datosUsuario" method = "POST" action="../php/modificarUsuario.php">
                <input type="hidden" name="formulario" class="datos" autocomplete="off" value="1" readonly>
                ...
                <input class="boton" name="btnEnviar" type="submit" id="btnEnviar" value="Guardar Datos">
            </form>
        </section>
